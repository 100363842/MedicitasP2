...
var SignInPatientPage = /** @class */ (function () {
    ...
    SignInPatientPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-sign-in-patient',template:/*ion-inline-start:"I:\Carlos\Documents\IonicProjects\DSI\Medicitas\src\pages\sign-in-patient\sign-in-patient.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      <img id="backButton" src="../../assets/imgs/back.png" alt="back" (click)="goBack()">\n      Medicitas\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding id="body">\n  <form (ngSubmit)="signInPatient(f.value)" #f="ngForm">\n    <div id="number">\n      <p>Número de afiliación a la seguridad social</p>\n      <input type="number" name="number" ngModel required>\n    </div>\n    <div id="code">\n      <p>Fecha de nacimiento</p>\n      <input type="date" name="date" ngModel required>\n    </div>\n    <button ion-button id="save" type="submit" [disabled]="!f.valid">Confirmar</button>\n    </form>\n</ion-content>\n'/*ion-inline-end:"I:\Carlos\Documents\IonicProjects\DSI\Medicitas\src\pages\sign-in-patient\sign-in-patient.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__doctor_doctor__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_firebase_db_firebase_db__ = __webpack_require__(57);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var SignInDoctorPage = /** @class */ (function () {
    ...
    SignInDoctorPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-sign-in-doctor',template:/*ion-inline-start:"I:\Carlos\Documents\IonicProjects\DSI\Medicitas\src\pages\sign-in-doctor\sign-in-doctor.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      <img id="backButton" src="../../assets/imgs/back.png" alt="back" (click)="goBack()">\n      Medicitas\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding id="body">\n  <form (ngSubmit)="signInDoctor(f.value)" #f="ngForm">\n    <div id="number">\n      <p>Número de colegiado</p>\n      <input type="number" name="number" ngModel required>\n    </div>\n    <div id="code">\n      <p>Código de seguridad</p>\n      <input type="date" name="date" ngModel required>\n    </div>\n    <button ion-button id="save" type="submit" [disabled]="!f.valid">Confirmar</button>\n    </form>\n</ion-content>\n'/*ion-inline-end:"I:\Carlos\Documents\IonicProjects\DSI\Medicitas\src\pages\sign-in-doctor\sign-in-doctor.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__providers_firebase_db_firebase_db__["a" /* FirebaseDbProvider */]])
    ], SignInDoctorPage);
...
var PatientOptionsPage = /** @class */ (function () {
    ...
    PatientOptionsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-patient-options',template:/*ion-inline-start:"I:\Carlos\Documents\IonicProjects\DSI\Medicitas\src\pages\patient-options\patient-options.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      <img id="backButton" src="../../assets/imgs/back.png" alt="back" (click)="goBack()">\n      Medicitas\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding id="body">\n  <div id="frame">\n    <p>Elige a qué funcionalidad quieres acceder</p>\n    <button ion-button  id="patientButton" (click)="goToAppointmentPage()">Pedir cita</button>\n    <button ion-button id="doctorButton" (click)="goToTimeTablePage()">Ver horario</button>\n  </div>\n</ion-content>\n'/*ion-inline-end:"I:\Carlos\Documents\IonicProjects\DSI\Medicitas\src\pages\patient-options\patient-options.html"*/,
        }),
...
var TimeTablePage = /** @class */ (function () {
    ...
    TimeTablePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-time-table',template:/*ion-inline-start:"I:\Carlos\Documents\IonicProjects\DSI\Medicitas\src\pages\time-table\time-table.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      <img id="backButton" src="../../assets/imgs/back.png" alt="back" (click)="goBack()">\n      Medicitas\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding id="body">\n  <p>Citas en tiempo real</p>\n  <div id="timeTable">\n    <ng-container *ngFor=\'let finishedAppointment of finishedAppointments\'>\n        <p class="finishedAppointment" [style.color]="getColor(finishedAppointment.securityNumber)">{{finishedAppointment.time}}</p>\n    </ng-container>\n    <ng-container *ngFor=\'let remainingAppointment of remainingAppointments\'>\n        <p class="remainingAppointment" *ngIf=\'isToday(remainingAppointment.date)\' [style.color]="getColor(remainingAppointment.securityNumber)">{{remainingAppointment.time}}</p>\n    </ng-container>\n  </div>\n  <p><span>Tu cita</span> tiene aproximadamente 20 minutos de retraso.</p>\n</ion-content>\n'/*ion-inline-end:"I:\Carlos\Documents\IonicProjects\DSI\Medicitas\src\pages\time-table\time-table.html"*/,
            providers: [__WEBPACK_IMPORTED_MODULE_3__angular_common__["d" /* DatePipe */]]
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */]) === "function" ? _a : Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]) === "function" ? _b : Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__providers_firebase_db_firebase_db__["a" /* FirebaseDbProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_firebase_db_firebase_db__["a" /* FirebaseDbProvider */]) === "function" ? _c : Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__angular_common__["d" /* DatePipe */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_common__["d" /* DatePipe */]) === "function" ? _d : Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__ionic_native_local_notifications__["a" /* LocalNotifications */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__ionic_native_local_notifications__["a" /* LocalNotifications */]) === "function" ? _e : Object])
    ], TimeTablePage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sign_in_doctor_sign_in_doctor__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sign_in_patient_sign_in_patient__ = __webpack_require__(109);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_doctor_doctor__ = __webpack_require__(110);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_sign_in_patient_sign_in_patient__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_sign_in_doctor_sign_in_doctor__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_doctor_doctor__ = __webpack_require__(110);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_sign_in_patient_sign_in_patient__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_sign_in_doctor_sign_in_doctor__ = __webpack_require__(111);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"I:\Carlos\Documents\IonicProjects\DSI\Medicitas\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"I:\Carlos\Documents\IonicProjects\DSI\Medicitas\src\app\app.html"*/
        }),
